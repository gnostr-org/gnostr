...
use crate::{
    ...
    sync::{
        ...
        rebase::{abort_rebase, continue_rebase, get_rebase_progress},
        repository::repo,
...
///
pub fn merge_branch(repo_path: &RepoPath, branch: &str, branch_type: BranchType) -> Result<()> {
...
///
pub fn rebase_progress(repo_path: &RepoPath) -> Result<RebaseProgress> {
...
///
pub fn continue_pending_rebase(repo_path: &RepoPath) -> Result<RebaseState> {
...
///
pub fn merge_branch_repo(repo: &Repository, branch: &str, branch_type: BranchType) -> Result<()> {
...
///
pub fn merge_commit(repo_path: &RepoPath, msg: &str, ids: &[CommitId]) -> Result<CommitId> {
...
mod tests {
    ...
    fn test_smoke() {
        ...
        let c1 = write_commit_file(&repo, "test.txt", "test", "commit1");
