...
pub fn get_js_assets() -> HashMap<String, &'static [u8]> {
    ...
    //2.0
    assets.insert(
        "w2ui-2.0.js".to_string(),
        include_bytes!("w2ui-2.0.js") as &'static [u8],
    );
    ...
    assets.insert(
        "query.js".to_string(),
        include_bytes!("query.js") as &'static [u8],
    ); //manually insert
       //assets.insert("jquery.js".to_string(), include_bytes!("jquery-4.0.0.js") as &'static [u8]); //manually insert

    //defer?
    assets.insert(
        "w2layout.js".to_string(),
        include_bytes!("w2layout.js") as &'static [u8],
    );
    assets
}
