...
use crate::{
    tui::git::items::TargetData,
    tui::git::menu::PendingMenu,
    tui::git::screen::NavMode,
    tui::git::state::{root_menu, PromptParams, State},
    tui::shared::term::Term,
};
use std::rc::Rc;
...
pub(crate) struct OpenMenu(pub crate::tui::git::menu::Menu);
