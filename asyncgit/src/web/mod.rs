...
pub const GLOBAL_CSS: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/src/web/css/style.css"));
pub const GLOBAL_CSS_HASH: &str = const_hex::Buffer::<16, false>::new()
    ...
    .as_str();
pub const JS_BUNDLE: &[u8] = include_bytes!(concat!(env!("OUT_DIR"), "/src/web/js/bundle.js"));
...
pub fn init_static_asset_hashes() {
    ...
    let css = {
        let theme =
            toml::from_str::<crate::web::theme::Theme>(include_str!("../../themes/solarized_light.toml"))
                .unwrap()
                .build_css();
        Box::leak(
