...
fn build_scss(paths: Paths) -> anyhow::Result<()> {
    let in_dir = paths.statics_in_dir.join("src/web/sass");
    let out_dir = paths.statics_out_dir.join("src/web/css");
...
fn build_js(paths: Paths) -> anyhow::Result<()> {
    let in_dir = paths.statics_in_dir.join("src/web/js");
    let ui_in_dir = in_dir.join("ui");
    let out_dir = paths.statics_out_dir.join("src/web/js");
