...
use crate::{
    ...
    git::{Repo, RepoActions, nostr_url::NostrUrlDecoded, utils::set_git_timeout},
...
#[path = "../bin/git_remote_nostr/fetch.rs"]
mod fetch;
#[path = "../bin/git_remote_nostr/list.rs"]
mod list;
#[path = "../bin/git_remote_nostr/push.rs"]
mod push;
