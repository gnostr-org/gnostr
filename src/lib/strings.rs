...
pub fn confirm_title_stashdrop(_key_config: &SharedKeyConfig, multiple: bool) -> String {
    format!("Drop Stash{}", if multiple { "es" } else { "" })
}
pub fn confirm_title_stashpop(_key_config: &SharedKeyConfig) -> String {
    "Pop".to_string()
}
pub fn confirm_title_merge(_key_config: &SharedKeyConfig, rebase: bool) -> String {
    if rebase {
...
pub fn confirm_msg_merge(_key_config: &SharedKeyConfig, incoming: usize, rebase: bool) -> String {
    if rebase {
...
pub fn confirm_msg_revertchanges() -> String {
    "This will revert all uncommitted changes. Are you sure?".to_string()
}
...
pub fn confirm_msg_reset_lines(lines: usize) -> String {
    format!("are you sure you want to discard {lines} selected lines?")
}
pub fn confirm_msg_undo_commit() -> String {
    "confirm undo last commit?".to_string()
}
pub fn confirm_msg_stashdrop(_key_config: &SharedKeyConfig, ids: &[CommitId]) -> String {
    format!(
...
pub fn confirm_msg_stashpop(_key_config: &SharedKeyConfig) -> String {
    "The stash will be applied and removed from the stash list. Confirm stash pop?".to_string()
}
pub fn confirm_msg_resethunk(_key_config: &SharedKeyConfig) -> String {
    "confirm reset hunk?".to_string()
}
pub fn confirm_title_delete_branch(_key_config: &SharedKeyConfig) -> String {
    "Delete Branch".to_string()
}
pub fn confirm_msg_delete_branch(_key_config: &SharedKeyConfig, branch_ref: &str) -> String {
    format!("Confirm deleting branch: '{branch_ref}' ?")
}
pub fn confirm_title_delete_remote_branch(_key_config: &SharedKeyConfig) -> String {
    "Delete Remote Branch".to_string()
}
pub fn confirm_msg_delete_remote_branch(_key_config: &SharedKeyConfig, branch_ref: &str) -> String {
    format!("Confirm deleting remote branch: '{branch_ref}' ?")
}
pub fn confirm_title_delete_tag(_key_config: &SharedKeyConfig) -> String {
    "Delete Tag".to_string()
}
pub fn confirm_msg_delete_tag(_key_config: &SharedKeyConfig, tag_name: &str) -> String {
...
pub fn confirm_title_force_push(_key_config: &SharedKeyConfig) -> String {
...
pub fn file_log_title(file_path: &str, selected: usize, revisions: usize) -> String {
...
pub fn stashing_options_title(_key_config: &SharedKeyConfig) -> String {
    "Options".to_string()
}
pub fn loading_text(_key_config: &SharedKeyConfig) -> String {
    "Loading ...".to_string()
}
pub fn create_branch_popup_title(_key_config: &SharedKeyConfig) -> String {
    "Branch".to_string()
}
pub fn create_branch_popup_msg(_key_config: &SharedKeyConfig) -> String {
...
pub mod commands {
    ...
    pub fn toggle_tabs(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Next [{}]", key_config.get_hint(key_config.keys.tab_toggle)),
            "switch to next tab",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn find_file(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Find [{}]", key_config.get_hint(key_config.keys.file_find)),
            "find file in tree",
            CMD_GROUP_GENERAL,
        )
    }
    ...
    pub fn navigate_commit_message(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Nav [{}{}]",
    ...
    pub fn navigate_tree(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Nav [{}{}{}{}]",
                key_config.get_hint(key_config.keys.move_up),
    ...
    pub fn commit_list_mark(key_config: &SharedKeyConfig, marked: bool) -> CommandText {
        CommandText::new(
            format!(
                "{} [{}]",
    ...
    pub fn copy(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Copy [{}]", key_config.get_hint(key_config.keys.copy),),
    ...
    pub fn copy_hash(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Copy Hash [{}]", key_config.get_hint(key_config.keys.copy),),
    ...
    pub fn copy_path(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Copy Path [{}]", key_config.get_hint(key_config.keys.copy),),
    ...
    pub fn push_tags(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Push Tags [{}]", key_config.get_hint(key_config.keys.push),),
            "push tags to remote",
            CMD_GROUP_LOG,
        )
    }
    pub fn toggle_option(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Toggle Option [{}]",
                key_config.get_hint(key_config.keys.log_mark_commit),
    ...
    pub fn show_tag_annotation(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Annotation [{}]",
                key_config.get_hint(key_config.keys.move_right),
    ...
    pub fn diff_hunk_prev(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Prev hunk [{}]",
    ...
    pub fn diff_hunk_add(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Add hunk [{}]",
                key_config.get_hint(key_config.keys.stage_unstage_item),
            ),
            "adds selected hunk to stage",
            CMD_GROUP_DIFF,
        )
    }
    pub fn diff_hunk_revert(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Reset hunk [{}]",
                key_config.get_hint(key_config.keys.status_reset_item),
            ),
            "reverts selected hunk",
            CMD_GROUP_DIFF,
        )
    }
    pub fn diff_lines_revert(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Reset lines [{}]",
    ...
    pub fn diff_lines_stage(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Stage lines [{}]",
    ...
    pub fn diff_lines_unstage(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Unstage lines [{}]",
                key_config.get_hint(key_config.keys.diff_stage_lines),
    ...
    pub fn diff_hunk_remove(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Remove hunk [{}]",
                key_config.get_hint(key_config.keys.stage_unstage_item),
    ...
    pub fn close_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Close [{}]", key_config.get_hint(key_config.keys.enter),),
    ...
    pub fn validate_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Validate [{}]", key_config.get_hint(key_config.keys.enter),),
            "validate msg",
            CMD_GROUP_GENERAL,
        )
        .hide_help()
    ...
    pub fn view_submodules(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Submodules [{}]",
    ...
    pub fn open_submodule(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Open [{}]", key_config.get_hint(key_config.keys.enter),),
            "open submodule",
            CMD_GROUP_GENERAL,
        )
    }

    pub fn open_submodule_parent(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Open Parent [{}]",
                key_config.get_hint(key_config.keys.view_submodule_parent),
            ),
    ...
    pub fn update_submodule(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Update [{}]",
    ...
    pub fn commit_open_editor(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Open editor [{}]",
                key_config.get_hint(key_config.keys.open_commit_editor),
            ),
    ...
    pub fn commit_next_msg_from_history(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Previous Msg [{}]",
                key_config.get_hint(key_config.keys.commit_history_next),
            ),
            "use previous commit message from history",
            CMD_GROUP_COMMIT_POPUP,
        )
    }
    pub fn commit_submit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Do Commit [{}]",
    ...
    pub fn toggle_verify(key_config: &SharedKeyConfig, current_verify: bool) -> CommandText {
    ...
    pub fn commit_signoff(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Sign-off [{}]",
    ...
    pub fn edit_item(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Edit [{}]", key_config.get_hint(key_config.keys.edit_file),),
    ...
    pub fn ignore_item(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Ignore [{}]",
                key_config.get_hint(key_config.keys.status_ignore_file),
            ),
    ...
    pub fn diff_focus_left(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Back [{}]", key_config.get_hint(key_config.keys.move_left),),
            "view and select changed files",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn diff_focus_right(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Diff [{}]", key_config.get_hint(key_config.keys.move_right),),
            "inspect file diff",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn quit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Quit [{}]", key_config.get_hint(key_config.keys.exit),),
            "quit gitui application",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn confirm_action(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Confirm [{}]", key_config.get_hint(key_config.keys.enter),),
            "confirm action",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn stashing_save(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Save [{}]",
    ...
    pub fn stashing_toggle_indexed(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Toggle Staged [{}]",
                key_config.get_hint(key_config.keys.stashing_toggle_index),
            ),
            "toggle including staged files into stash",
            CMD_GROUP_STASHING,
        )
    }
    pub fn stashing_toggle_untracked(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Toggle Untracked [{}]",
                key_config.get_hint(key_config.keys.stashing_toggle_untracked),
            ),
            "toggle including untracked files into stash",
            CMD_GROUP_STASHING,
        )
    }
    pub fn stashing_confirm_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Stash [{}]", key_config.get_hint(key_config.keys.enter),),
            "save files to stash",
            CMD_GROUP_STASHING,
        )
    }
    pub fn stashlist_apply(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Apply [{}]",
    ...
    pub fn stashlist_drop(key_config: &SharedKeyConfig, marked: usize) -> CommandText {
        CommandText::new(
            format!(
                "Drop{} [{}]",
                if marked == 0 {
    ...
    pub fn stashlist_pop(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Pop [{}]", key_config.get_hint(key_config.keys.enter),),
            "pop selected stash",
            CMD_GROUP_STASHES,
        )
    }
    pub fn stashlist_inspect(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Inspect [{}]",
    ...
    pub fn blame_file(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Blame [{}]", key_config.get_hint(key_config.keys.blame),),
    ...
    pub fn log_checkout_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Checkout [{}]",
                key_config.get_hint(key_config.keys.log_checkout_commit),
            ),
            "checkout commit",
            CMD_GROUP_LOG,
        )
    }
    pub fn inspect_file_tree(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Files [{}]",
    ...
    pub fn revert_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Revert [{}]",
                key_config.get_hint(key_config.keys.status_reset_item),
    ...
    pub fn log_reset_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Reset [{}]",
    ...
    pub fn log_reword_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Reword [{}]",
                key_config.get_hint(key_config.keys.log_reword_commit),
            ),
            "reword commit message",
            CMD_GROUP_LOG,
        )
    }
    pub fn log_find_commit(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Find [{}]", key_config.get_hint(key_config.keys.file_find),),
            "start commit search",
            CMD_GROUP_LOG,
    ...
    pub fn tag_annotate_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Annotate [{}]",
    ...
    pub fn create_branch_confirm_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Create Branch [{}]",
                key_config.get_hint(key_config.keys.enter),
    ...
    pub fn open_branch_create_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Create [{}]",
    ...
    pub fn rename_branch_confirm_msg(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Rename Branch [{}]",
                key_config.get_hint(key_config.keys.enter),
    ...
    pub fn rename_branch_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Rename Branch [{}]",
    ...
    pub fn branch_popup_rebase(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Rebase [{}]",
                key_config.get_hint(key_config.keys.rebase_branch),
    ...
    pub fn compare_with_head(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Compare [{}]",
    ...
    pub fn compare_commits(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Compare Commits [{}]",
                key_config.get_hint(key_config.keys.compare_commits),
    ...
    pub fn select_branch_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Checkout [{}]", key_config.get_hint(key_config.keys.enter),),
            "checkout branch",
            CMD_GROUP_BRANCHES,
        )
    }
    pub fn toggle_branch_popup(key_config: &SharedKeyConfig, local: bool) -> CommandText {
        CommandText::new(
            format!(
                "{} [{}]",
    ...
    pub fn open_branch_select_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Branches [{}]",
    ...
    pub fn open_tags_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Tags [{}]", key_config.get_hint(key_config.keys.tags),),
            "open tags popup",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn delete_tag_popup(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Delete [{}]",
    ...
    pub fn status_push(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Push [{}]", key_config.get_hint(key_config.keys.push),),
            "push to origin",
            CMD_GROUP_GENERAL,
        )
    }
    ...
    pub fn status_fetch(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Fetch [{}]", key_config.get_hint(key_config.keys.fetch),),
            "fetch",
            CMD_GROUP_GENERAL,
        )
    }
    pub fn status_pull(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!("Pull [{}]", key_config.get_hint(key_config.keys.pull),),
            "fetch/merge",
            CMD_GROUP_GENERAL,
        )
    }
    ...
    pub fn find_commit_sha(key_config: &SharedKeyConfig) -> CommandText {
        CommandText::new(
            format!(
                "Search Hash [{}]",
