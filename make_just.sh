...
gh-act-run-all: 	### 	gh-act-run-all
	...
	gh act \${ACT_VERBOSE} -W .github/workflows/run-all-workflows.yml --container-architecture linux/amd64 || \
	act \${ACT_VERBOSE} -W .github/workflows/run-all-workflows.yml --container-architecture linux/amd64

gnostr-bot-matrix: 	### 	gnostr-bot-matrix
	gh extension install nektos/gh-act || true
	gh act \${ACT_VERBOSE} -W .github/workflows/gnostr-bot-matrix.yml --container-architecture linux/amd64 || \
	act \${ACT_VERBOSE} -W .github/workflows/gnostr-bot-matrix.yml --container-architecture linux/amd64

gnostr-bot-macos: 	### 	gnostr-bot-macos
	gh extension install nektos/gh-act || true
	gh act \${ACT_VERBOSE} -W .github/workflows/gnostr-bot-matrix.yml -P macos-latest=-self-hosted --container-architecture linux/amd64 || \
	   act \${ACT_VERBOSE} -W .github/workflows/gnostr-bot-matrix.yml -P macos-latest=-self-hosted --container-architecture linux/amd64
gnostr-bot-macos-intel: 	### 	gnostr-bot-macos
	gh extension install nektos/gh-act || true
	gh act \${ACT_VERBOSE} -W .github/workflows/gnostr-bot-matrix.yml -P macos-15-intel=-self-hosted --container-architecture linux/amd64 || \
	   act \${ACT_VERBOSE} -W .github/workflows/gnostr-bot-matrix.yml -P macos-15-intel=-self-hosted --container-architecture linux/amd64
