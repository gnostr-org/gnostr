...
BEGIN {
    ...
    require '/Users/Shared/gnostr-org/gnostr/ext/openssl-3.0.10/util/perl/OpenSSL/Util.pm';
    OpenSSL::Util->import();
}
...
if ($ARGV[0] eq '-fips') {
    $std_openssl_conf = '/Users/Shared/gnostr-org/gnostr/ext/openssl-3.0.10/test/fips-and-base.cnf';
    shift;
