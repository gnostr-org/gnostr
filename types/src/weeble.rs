...
/// Calculates the weeble value (utc_secs / blockheight).
pub fn weeble() -> Result<f64, ascii::AsciiChar> {
    weeble_sync()
}
/// pub fn weeble_sync() -> Result<f64, ascii::AsciiChar>
/// Calculates the synchronous weeble value (utc_secs / blockheight).
pub fn weeble_sync() -> Result<f64, ascii::AsciiChar> {
...
/// Calculates the synchronous weeble value in milliseconds (utc_millis / blockheight).
pub fn weeble_millis_sync() -> Result<f64, ascii::AsciiChar> {
    // weeble = utc_secs / blockheight
    let since_the_epoch = SystemTime::now()
        .duration_since(SystemTime::UNIX_EPOCH)
...
/// Calculates the asynchronous weeble value (utc_secs / blockheight).
pub async fn weeble_async() -> Result<f64, ascii::AsciiChar> {
    // weeble = utc_secs / blockheight
    let since_the_epoch = SystemTime::now()
        .duration_since(SystemTime::UNIX_EPOCH)
...
/// Calculates the asynchronous weeble value in milliseconds (utc_millis / blockheight).
