...
/// Calculates the wobble value (utc_secs % blockheight).
pub fn wobble() -> Result<f64, ascii::AsciiChar> {
    wobble_sync()
}
/// pub fn wobble_sync() -> Result<f64, ascii::AsciiChar>
/// Calculates the synchronous wobble value (utc_secs % blockheight).
pub fn wobble_sync() -> Result<f64, ascii::AsciiChar> {
...
/// Calculates the synchronous wobble value in milliseconds (utc_millis % blockheight).
pub fn wobble_millis_sync() -> Result<f64, ascii::AsciiChar> {
    // wobble = utc_secs % blockheight
    let since_the_epoch = SystemTime::now()
        .duration_since(SystemTime::UNIX_EPOCH)
...
/// Calculates the asynchronous wobble value (utc_secs % blockheight).
pub async fn wobble_async() -> Result<f64, ascii::AsciiChar> {
    // wobble = utc_secs / blockheight
    let since_the_epoch = SystemTime::now()
        .duration_since(SystemTime::UNIX_EPOCH)
...
/// Calculates the asynchronous wobble value in milliseconds (utc_millis % blockheight).
