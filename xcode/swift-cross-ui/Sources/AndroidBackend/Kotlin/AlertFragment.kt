...
class AlertFragment() : DialogFragment() {
    ...
    override fun onCreateDialog(savedInstanceState: Bundle?): Dialog {
        ...
        val titleView =
            TextView(context, null, 0, R.style.TextAppearance_DeviceDefault_DialogWindowTitle)
    ...
    fun update(title: String, buttons: Array<String>) {
        titleText = title
    ...
    private fun setButtons() {
        ...
        buttonContainer.orientation =
            if (buttonTexts.size > 3) LinearLayout.VERTICAL else LinearLayout.HORIZONTAL
