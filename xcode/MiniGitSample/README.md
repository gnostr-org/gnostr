...
It advertises the current repo over gossipsub and serves a repo snapshot over a libp2p request/response route so peers can clone from the shared announcement list.
