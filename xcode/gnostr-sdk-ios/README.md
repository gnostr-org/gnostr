...
- [ ] [NIP-26: Delegated Event Signing](https://github.com/nostr-protocol/nips/blob/master/26.md) --- **unrecommended**: adds unnecessary burden for little gain
...
- [ ] [NIP-43: Relay Access Metadata and Requests](https://github.com/nostr-protocol/nips/blob/master/43.md)
...
- [ ] [NIP-96: HTTP File Storage Integration](https://github.com/nostr-protocol/nips/blob/master/96.md) --- **unrecommended**: replaced by blossom APIs
...
- [ ] [NIP-A4: Public Messages](https://github.com/nostr-protocol/nips/blob/master/A4.md)
...
- [ ] [NIP-BE: Nostr BLE Communications Protocol](https://github.com/nostr-protocol/nips/blob/master/BE.md)
- [ ] [NIP-C0: Code Snippets](https://github.com/nostr-protocol/nips/blob/master/C0.md)
- [ ] [NIP-C7: Chats](https://github.com/nostr-protocol/nips/blob/master/C7.md)
- [ ] [NIP-EE: E2EE Messaging using MLS Protocol](https://github.com/nostr-protocol/nips/blob/master/EE.md) --- **unrecommended**: superseded by the [Marmot Protocol](https://github.com/marmot-protocol/marmot)
