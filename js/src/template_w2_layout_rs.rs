#[allow(unused)]
pub struct TemplateW2Layout {
    pub template_html: &'static [u8],
}

impl TemplateW2Layout {
    pub fn new() -> Self {
        let template_html_bytes: &'static [u8] = include_bytes!("template_w2_layout.html");
        TemplateW2Layout {
    ...
    pub fn to_string(&self) -> String {
        if let Ok(template_html_string) = String::from_utf8(self.template_html.to_vec()) {
            ...
            String::from("template_w2_layout.html is not valid UTF-8.")
        }
    }
}
