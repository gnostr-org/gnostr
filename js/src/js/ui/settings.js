...
function new_relay_discovery_item(entry, model) {
	...
	if (template instanceof HTMLTemplateElement && template.content.firstElementChild) {
		...
		summary.innerHTML = `<img class="relay-discovery-nip34 relay-discovery-nip34-light icon svg small hide" src="/images/logo.svg" alt="NIP-34"/><img class="relay-discovery-nip34 relay-discovery-nip34-dark icon svg small hide" src="/images/logo-inverted.svg" alt="NIP-34"/><a href="#" class="details-relay relay-address" data-address=""><span data-relay-address></span></a><button class="add-discovered-relay btn-text" data-address="" role="add-discovered-relay" aria-label="Add relay" title="Add relay"><img class="icon svg small relay-add-icon" src="/images/add-relay.svg"/></button>`;
