...
const gnostrWeb = {
	start: (...args) => globalThis.gnostr_web_start(...args),
	init: (...args) => globalThis.gnostr_web_init(...args),
	ready: (...args) => globalThis.gnostr_web_init_ready(...args),
	signin: (...args) => globalThis.signin(...args),
	webapp_init: (...args) => globalThis.webapp_init(...args),
	parse_url_mode: (...args) => globalThis.parse_url_mode(...args),
	get model() {
		return GNOSTR;
	},
};
