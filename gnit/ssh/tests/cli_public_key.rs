...
[users]\n",
    ...
    Command::cargo_bin("gnostr-ssh")?
        ...
        .stderr(predicate::str::contains(
            "User 'testuser_file' added/updated successfully.",
        ));
...
[users]\n",
    ...
    Command::cargo_bin("gnostr-ssh")?
        ...
        // The success message is printed to stderr, not stdout.
        .stderr(predicate::str::contains(
            "User 'testuser_direct' added/updated successfully.",
        ));
...
[users]\n",
    ...
    Command::cargo_bin("gnostr-ssh")?
        ...
        .success()
        .stderr(predicate::str::contains(
            "User 'testuser_nonexistent' added/updated successfully.",
        ));
...
[users]\n",
    ...
    Command::cargo_bin("gnostr-ssh")?
        ...
        .success()
        .stderr(predicate::str::contains(
            "User 'testuser_invalid_key' added/updated successfully.",
        ));
