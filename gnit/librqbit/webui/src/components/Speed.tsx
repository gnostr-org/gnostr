import { TorrentStats, STATE_INITIALIZING, STATE_PAUSED, STATE_ERROR } from "../api-types"
import { formatBytes } from "../helper/formatBytes"

export const Speed: React.FC<{ statsResponse: TorrentStats }> = ({ statsResponse }) => {
    ...
    <>
      ...
      <div className="upload-speed">
        ...
        {statsResponse.live.snapshot.uploaded_bytes > 0 && (
          <span>({formatBytes(statsResponse.live.snapshot.uploaded_bytes)})</span>
        )}
      </div>
    </>
  )
