...
export const FileInput = ({ className }: { className?: string }) => {
  ...
  return (
    <>
      <input type="file" ref={inputRef} accept=".torrent" onChange={onFileChange} hidden />
      <UploadButton onClick={onClick} data={file} resetData={reset} className={`group ${className}`}>
