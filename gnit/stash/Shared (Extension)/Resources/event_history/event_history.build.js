...
${expression ? 'Expression: "' + expression + '"\n\n' : ""}`, el);
  ...
  module_default.data("eventLog", () => ({
    ...
    highlight(event) {
      return (0, import_json_format_highlight.default)(event);
    },
